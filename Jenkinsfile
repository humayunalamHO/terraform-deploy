...
//                ansiblePlaybook become: true, credentialsId: 'jenkins-ssh', disableHostKeyChecking: true, playbook: 'site.yml', inventory: 'inventory.yml'
                ansiblePlaybook becomeUser: 'jenkins', credentialsId: 'jenkins-ssh', installation: 'ansible', inventory: 'ansible/inventory.yml', playbook: 'ansible/main.yml', vaultTmpPath: ''
            }
        }
